 ...
 *
 * 홈 화면 앱(standalone)만은 예외다 — 툴바가 없는데 iOS가 fixed 컨테이너의 아래 끝을
 * 짧게 잡아 탭바가 바닥에서 뜬다. 거기서만 높이를 100lvh로 바꾼다. 미디어 쿼리가
 * 필요해서 이 래퍼만 인라인이 아니라 globals.css의 .neo-viewport 클래스로 둔다.
 *
